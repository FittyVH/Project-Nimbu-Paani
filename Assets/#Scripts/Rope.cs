...
public class Rope : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 ropeStartPoint = juicerEnd.transform.position;
    ...
    private void ApplyConstraint()
    {
        ...
        firstSegment.posNow = juicerEnd.transform.position;
    ...
    void HandleCollisions()
    {
        for (int i = 1; i < ropeSegments.Count; i++)
        {
            ...
            foreach (Collider2D collider in colliders)
            {
                ...
                float distance = Vector2.Distance(segment.posNow, closestPoint);
